...
export const ConfidencialModal = forwardRef((_, ref) => {
  const modalizeRef = useRef(null);
  const combinedRef = useCombinedRefs(ref, modalizeRef);

  const renderContent = () => [
    <View style={s.content__header} key="0">
      <Text style={s.content__heading}>Политика конфиденциальности</Text>
    </View>,
    <View style={s.content__inside} key="1">
      ...
      <Text style={s.content__paragraph}>
        ...
        безопасности персональных данных, предпринимаемые ООО «Интернетика»
        (далее – Оператор).
      </Text>
      <Text style={s.content__paragraph}>
      ...
      <Text style={s.content__paragraph}>
        ...
        Оператор может получить о посетителях веб-сайта https://genray.ru.
      </Text>
      <Text
        style={[s.content__paragraph, {fontWeight: '700', marginVertical: 5}]}>
      ...
      <Text style={s.content__paragraph}>
        ...
        сети интернет по сетевому адресу https://genray.ru.
      </Text>
      <Text style={s.content__paragraph}>
      ...
      <Text style={s.content__paragraph}>
        2.10. Пользователь – любой посетитель веб-сайта https://genray.ru.
      </Text>
      <Text style={s.content__paragraph}>
      ...
      <Text style={s.content__paragraph}>3.1. Оператор имеет право:</Text>
      <Text style={s.content__paragraph}>
        {' '}
      ...
      <Text style={s.content__paragraph}>3.2. Оператор обязан:</Text>
      <Text style={s.content__paragraph}>
        {' '}
      ...
      <Text style={s.content__paragraph}>5.1. Фамилия, имя, отчество.</Text>
      <Text style={s.content__paragraph}>5.2. Электронный адрес.</Text>
      <Text style={s.content__paragraph}>5.3. Номера телефонов.</Text>
      <Text style={s.content__paragraph}>5.4. Фотографии.</Text>
      <Text style={s.content__paragraph}>
      ...
      <Text style={s.content__paragraph}>
        ...
        материалам, содержащимся на веб-сайте https://genray.ru.
      </Text>
      <Text style={s.content__paragraph}>
        ...
        почты info@genray.ru с пометкой «Отказ от уведомлений о новых продуктах
      ...
      <Text style={s.content__paragraph}>
        ...
        специальные формы, расположенные на сайте https://genray.ru или
      ...
      <Text style={s.content__paragraph}>
        ...
        уведомление на адрес электронной почты Оператора info@genray.ru с
      ...
      <Text style={s.content__paragraph}>
        ...
        электронный адрес Оператора info@genray.ru с пометкой «Отзыв согласия на
      ...
      <Text style={s.content__paragraph}>
        ...
        Оператору с помощью электронной почты info@genray.ru.
      </Text>
      <Text style={s.content__paragraph}>
      ...
      <Text style={s.content__paragraph}>
        ...
        Интернет по адресу https://genray.ru/pl.
      </Text>
    </View>,
  ];
  return (
